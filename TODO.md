# Deployment Fix & Product Expansion TODO

- [x] Update backend/config.js with MongoDB SRV + Vercel URL
- [x] Update backend/index.js CORS allowedOrigins
- [x] Update frontend/src/lib/api.js production API base URL
